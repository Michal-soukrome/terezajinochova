  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">{dict.basic.description}</p>
      </div>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-8 mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            <h2 className="text-2xl font-bold mb-4">{dict.basic.includes.title}</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4">{dict.basic.benefits.title}</h2>
            <ul className="space-y-3">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-6">{dict.basic.moreOptions.title}</h2>
        <p className="text-gray-600 mb-6">{dict.basic.moreOptions.description}</p>
        <a
